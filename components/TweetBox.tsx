...
function TweetBox( { setTweets }: Props) {
    ...
    return (
        <div className='flex space-x-2 p-5'>
            <img className='h-14 w-14 object-cover rounded-full mt-4' src={session?.user?.image || 'https://links.papareact.com/gll'} />
            ...
            <div className=' flex flex-1 items-center pl-2'>
                ...
                <form className=' flex flex-1 flex-col'>
                    ...
                    <div className=' flex items-center'>
                        ...
                        <button onClick={handleSubmit} disabled={!input || !session} className=' disabled:opacity-40 rounded-full bg-twitter px-5 py-2 font-bold text-white'>Tweet</button>
                    </div>
                    {imageUrlBoxIsOpen && (
